										...
										<div id="drugAddFormContainer">						
											<form action="database/add-bio-reg.php" method="POST" class="appForm">
												...
												<div class="appFormInputContainer">
													...
													<input type="number" class="appFormInput" id="quantity" name="quantity" min="0"  step="0.001" required/>	
												</div>
												<div class="appFormInputContainer">
					...
					BootstrapDialog.confirm({
						...
						message: '<form>\
						  <div class="form-group" style="display: flex; flex-direction: column;">\
						    ...
						    <input type="number" class="form-control" id="income" min="0" step="0.001">\
							<label for="expense">Расход:</label>\
						    <input type="number" class="form-control" id="expense" min="0" step="0.001">\
							<label for="emergency">Списание:</label>\
						    <input type="number" class="form-control" id="emergency" min="0" step="0.001">\
						  </div>\
						</form>',
