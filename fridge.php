...
<body>
	...
	<div id="dashboardMainContainer">
		<?php include('partials/app-sidebar3.php') ?>
					...
					<div class="row">
						<div class="column column-5">
							...
							<div id="drugAddFormContainer">						
								<form action="database/fridge-add.php" method="POST" class="appForm">
						...
						<div class="column column-7">
							<h1 class="section_header"><i class="fa fa-list"></i> Карта контроля температурного режима</h1>
							<div id="calendar"></div>
						</div>
					</div>					
				</div>
